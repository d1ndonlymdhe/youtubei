...
class Video extends _1.BaseVideo {
    ...
    load(data) {
        ...
        this.commentContinuation = (0, common_1.getContinuationFromItems)(itemSectionRenderer.contents);
        return this;
    }
    /**
    ...
    nextComments(count = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < count || count == 0; i++) {
                ...
                this.commentContinuation = (0, common_1.getContinuationFromItems)(continuationItems);
